...
- **Podpis praw autorskich w Gablocie** — ustalone: pole „Właściciel praw do zdjęcia",
  puste → wpisujemy producenta, na karcie `Fot. Good Smile Company`. **Niezaimplementowane.**
...
- **Reguły dostępu do bazy (RLS)** — nie audytowane. **Do sprawdzenia przed premierą**,
  bo klucz publiczny i tak jest w kodzie strony.
...
3. Audyt RLS
4. Usuwanie konta (RODO)
5. Zasłona blokuje też roboty programów afiliacyjnych — przy zgłoszeniach potrzebny wyjątek
